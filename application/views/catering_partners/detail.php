        ...
        <div id="team-detail" class="carousel slide" data-ride="carousel">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <a href="<?php echo base_url() ?>catering_partners" class="back">BACK</a>
                    <!-- Controls -->
            ...
            <div class="item <?php if($row->slug == $slug){ echo 'active'; } ?>">
                <div class="row">
                    ...
                    <?php if(!empty($row->member_image)): ?>
                        <img src="<?php echo base_url() ?>assets/uploads/catering_partners/<?php echo $row->member_image; ?>" class="img-responsive">                        
                    <?php endif ?>
                    </div>
