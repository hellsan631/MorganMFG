		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>News Detail Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
					<p> Note : Heading font same use on ( News Page ) </p>	
				</div>
				<div class="row">              
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Date font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Description font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font size on tablet</label>
							...
							<div class="form-group">
								<label for="">Paragraphn anchor font color</label>
								<input type="text" class="form-control color" name="t_color" value="<?php echo $row->t_color; ?>">
							</div>

							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Paragraphn anchor font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Button font letter spacing</label>
