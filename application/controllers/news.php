...
class News extends CI_Controller {
	...
	public function edit($slug=""){
		...
		if ($this->form_validation->run() == TRUE){			
			...
			$this->session->set_flashdata('success_msg',"News has been updated successfully.");
			redirect('news/all');
	...
	public function delete($slug=""){	
		...
		$this->session->set_flashdata('success_msg',"News has been deleted successfully.");
