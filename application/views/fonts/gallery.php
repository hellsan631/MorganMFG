		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>Gallery Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
					...
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font size on tablet</label>
							...
							<div class="form-group">
								<label for="">Image Heading font color</label>
								<input type="text" class="form-control color" name="f_color" value="<?php echo $row->f_color; ?>">
							</div>

							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image Heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Image button font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font size on tablet</label>
							...
							<div class="form-group">
								<label for="">Page description font color</label>
								<input type="text" class="form-control color" name="fo_color" value="<?php echo $row->fo_color; ?>">
							</div>

							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Page description font letter spacing</label>
