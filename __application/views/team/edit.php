              ...
              <div class="col-sm-11 col-md-10 main">              
                ...
                <?php echo form_open_multipart(current_url()); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="" value="<?php echo $team->member_name; ?>" placeholder="Enter name">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="position" value="<?php echo $team->position; ?>" id="" placeholder="Enter position">
                  ...
                  <div class="form-group" style="display:none">
                    ...
                    <textarea class="mceEditor form-control" name="description" rows="3"><?php echo $team->description; ?></textarea>
                 ...
                 <div class="form-group" style="display:none">
                    ...
                    <input type="text" class="form-control" name="job_title" id="" value="<?php echo $team->job_title; ?>" placeholder="Enter job Title">
                  ...
                  <div class="form-group" style="display:none">
                    ...
                    <input type="text" class="form-control" name="hometown" id="" value="<?php echo $team->hometown; ?>" placeholder="Enter hometown">
                   ...
                   <div class="form-group" style="display:block">
                    ...
                    <input type="text" class="form-control" name="email_address" id="" value="<?php echo $team->email_address; ?>" placeholder="Enter email address">
                  ...
                  <div class="form-group" style="display:block">
                    ...
                    <input type="text" class="form-control" name="twitter_link" id="" value="<?php echo $team->twitter_link; ?>" placeholder="Enter twitter_link">
                  ...
                  <div class="form-group" style="display:block">
                    ...
                    <input type="text" class="form-control" name="fb_link" id="" value="<?php echo $team->fb_link; ?>" placeholder="">
