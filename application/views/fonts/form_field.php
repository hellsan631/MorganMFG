		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>Forms field Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
					<p> Inquiry form , Newsletter , Contact Form </p>
				</div>
				<div class="row">              
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Forms field font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Copyright font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Email anchor font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Required font letter spacing</label>
