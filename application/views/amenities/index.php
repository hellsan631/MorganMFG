        ...
        <?php if ($space): $i = 1; ?>
            <div class="row">
                <?php foreach ($space as $row): ?>
                    <a href="<?php echo base_url() ?>amenities/detail/<?php echo $row->slug; ?>" class="serv-bl">
                        <div style="background-image: url('<?php echo base_url() ?>assets/uploads/amenities/<?php echo $row->image ?>');" class="half-block tofade animated flipInY" style="opacity: 0;">
