              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo base_url() ?>sections/edit/<?php echo $row->slug ?>"><i class="glyphicon glyphicon-pencil"></i></a>

                         &nbsp;&nbsp;&nbsp;  

                         <a onclick="return confirm('Are you sure?')" href="<?php echo base_url() ?>sections/delete/<?php echo $row->slug ?>"><i class="glyphicon glyphicon-remove"></i></a>
