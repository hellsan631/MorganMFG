		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>Footer Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
				</div>
				<div class="row">              
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Address font letter spacing</label>
