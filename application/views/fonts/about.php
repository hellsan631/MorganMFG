		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>About Header Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
					...
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font size on tablet</label>
							...
							<div class="form-group">
								<label for="">Top Sub-heading font color</label>
								<input type="text" class="form-control color" name="s_color" value="<?php echo $row->s_color; ?>">
							</div>

							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Top Sub-heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font size on tablet</label>
							...
							<div class="form-group">
								<label for="">Body Sub-heading font color</label>
								<input type="text" class="form-control color" name="fo_color" value="<?php echo $row->fo_color; ?>">
							</div>

							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font weight</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Body Sub-heading font letter spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Event Heading font letter spacing</label>
