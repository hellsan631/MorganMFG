...
if($classes['f']){
	...
	if($f_color != ''){
		$class_style .= ".light::-moz-placeholder{";
		$class_style .= "\n\tcolor:#".$f_color." !important;";
		$class_style .= "\n}";

		$class_style .= ".light::-webkit-input-placeholder{";
		$class_style .= "\n\tcolor:#".$f_color." !important;";
		$class_style .= "\n}";

		$class_style .= ".light_brown::-moz-placeholder{";
		$class_style .= "\n\tcolor:#".$f_color." !important;";
		$class_style .= "\n}";

		$class_style .= ".light_brown::-webkit-input-placeholder{";
		$class_style .= "\n\tcolor:#".$f_color." !important;";
		$class_style .= "\n}";
	}
