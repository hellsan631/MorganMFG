              ...
              <div class="col-sm-11 col-md-10 main">              
                ...
                <?php echo form_open_multipart(current_url()); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="heading" id="" value="<?php if(set_value('heading')) echo set_value('heading'); else echo $sections->heading; ?>" placeholder="Enter Heading">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sub_heading" value="<?php if(set_value('sub_heading')) echo set_value('sub_heading'); else echo $sections->sub_heading; ?>" id="" placeholder="Enter Sub Heading">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="button_text" value="<?php if(set_value('button_text')) echo set_value('button_text'); else echo $sections->button_text; ?>" id="" placeholder="Enter Button Text">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="button_link" value="<?php if(set_value('button_link')) echo set_value('button_link'); else echo $sections->button_link; ?>" id="" placeholder="Enter Button Link">
...
<!--                       <span style="font-weight:lighter">(size:1400x700)</span>
 -->                      </label>
                   ...
                   <span class="error"><?php echo form_error('image'); ?></span>
                    ...
                    <img class="img_img" src="<?php echo base_url() ?>assets/uploads/sections/image/thumbs/<?php echo $sections->image ?>">
