       ...
       <?php else: ?>
         <div class="page-heading toflip parallax" style="background-image: url('<?php echo base_url() ?>assets/theme/img/new/profileheader2.jpg'); ">
       <?php endif; ?>
            <div class="container">
                <div class="row">
        ...
        <?php if ($content): $i=0; foreach($content as $row): ?>
            ...
            <div class="row prod-bl padder-cont <?php if($i==0){ echo 'hero'; } ?>" id="uno<?php echo $row->id ?>">
                <div class="col-lg-8 col-lg-offset-2 toflip">
                    <div class="inner">
