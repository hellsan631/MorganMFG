		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3>News Fonts <a href="<?php echo base_url() ?>fonts/reset/<?php echo $id ?>" class="btn btn-primary pull-right" onclick="return confirm('Are you sure?');"> Reset to default </a> </h3>
					<p> Note : Heading font same use on ( News Detail Page ) </p>	
				</div>
				<div class="row">              
					<div class="col-sm-11 col-md-10 main">              
						<?php echo form_open_multipart(current_url()); ?>               
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font name</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font size on web</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font size on mobile</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font size on tablet</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font line height</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font word spacing</label>
							...
							<div class="form-group">
								<div class="selectbox">
									<label for="">Excerpt font letter spacing</label>
