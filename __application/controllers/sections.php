...
class Sections extends CI_Controller {
	...
	public function edit($slug="")
	{
		...
		$data['sections']=$this->admin_model->get_row('sections',array('slug'=>$slug));		
		...
		if ($this->form_validation->run() == TRUE)
		{
		    ...
		    $this->admin_model->update('sections',$post_data, array('slug'=>$slug));
